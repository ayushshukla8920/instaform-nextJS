...
const LoginForm = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-[30%] h-[80%] rounded-xl bg-white text-black'>
            ...
            <form action="" className='w-full flex items-center flex-col'>
                ...
                <button className='w-[80%] h-10 bg-[#EFEFEF] mt-5 rounded-md flex items-center justify-center font-semibold'><FcGoogle className='text-xl mr-5' />Continue With Google</button>
            </form>
            <h1 className='mt-5'>Already have an Account ? <a className='text-[#B100A2] hover:cursor-pointer hover:underline' onClick={()=>{navigate('/login',{replace: true});}}>Login</a></h1>
            <ToastContainer
                position="top-right"
                autoClose={5000}
                hideProgressBar={false}
