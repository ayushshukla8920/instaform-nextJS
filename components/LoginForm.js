...
const LoginForm = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-[30%] h-[75%] rounded-xl bg-white text-black'>
            ...
            <form action="" className='w-full flex items-center flex-col'>
                ...
                <button onClick={() => {signIn("google",{ callbackUrl: "/" })}} className='w-[80%] h-10 bg-[#EFEFEF] mt-5 rounded-md flex items-center justify-center font-semibold'><FcGoogle className='text-xl mr-5' />Sign in With Google</button>
            </form>
            <h1 className='mt-5'>Don&apos;t have an Account ? <a className='text-[#B100A2] hover:cursor-pointer hover:underline' onClick={()=>{router.push('/signup');}}>Signup now</a></h1>
            <ToastContainer
                position="top-right"
                autoClose={5000}
                hideProgressBar={false}
